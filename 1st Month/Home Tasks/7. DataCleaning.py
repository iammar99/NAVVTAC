...
df11_clean['age'] = pd.to_numeric(df11_clean['age'], errors='coerce')
df11_clean["age"] = df11_clean["age"].replace(np.nan,df11_clean["age"].mean())
df11_clean = df11_clean.drop_duplicates()
